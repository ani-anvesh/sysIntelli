...
import com.sysintelli.pdfGenerator.repository.ImageUrlRepository;
...
public class PdfService {
	 ...
	 private ImageUrlRepository imageUrlRepository;
	    ...
	    public void uploadPdfToS3(byte[] pdfBytes, String fileName) {
	        try {
...
//                          break;
	...
	public byte[] generatePdf(Integer personId, Integer vistId) throws IOException {
		...
		try (PdfWriter writer = new PdfWriter(outputStream);
			...
			String imagePath = "C:\\Users\\CHANDRA SEKHAR\\Downloads\\Screenshot 2024-02-19 112546.png";
//			String imageKey = imageUrlRepository.findUrlByPersonId(1);
//			S3Object s3Object = amazonS3.getObject(new GetObjectRequest(bucketName, imageKey));
//			S3ObjectInputStream s3InputStream = s3Object.getObjectContent();
	       ...
	       // Image image = new Image(ImageDataFactory.create(imageUrl));
			...
			table3.addCell(new com.itextpdf.layout.element.Cell()
					.add(new Paragraph(
							"Address:2-169 Mayuri Nagar, Miyapur, Hyderabad, Telanagana\nGSTIN:36AYWPT5476M1FD"))
